...
from redteam.core import HttpResourceConnector
...
class TestResource(unittest.TestCase):
    ...
    def test_is_not_url(self):
        ...
        self.assertFalse(ResourceConnectorFactory.location_is_url(file_resource))

    def test_is_url(self):
        url_resource = 'https://access.redhat.com/labs/securitydataapi/cves.json'
        self.assertTrue(ResourceConnectorFactory.location_is_url(url_resource))

        update_url = 'https://access.redhat.com/labs/securitydataapi/cves.json?after=2017-10-17'
        self.assertTrue(ResourceConnectorFactory.location_is_url(update_url))

        test_archive = 'https://static.nvd.nist.gov/feeds/json/cve/1.0/nvdcve-1.0-2016.json.gz'
        self.assertTrue(ResourceConnectorFactory.location_is_url(test_archive))
    ...
    def test_open_from_directory(self):
        ...
        resource = Resource(os.path.join(self.test_data_path, 'exploit-source'))
